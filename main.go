...
import (
	...
	api "github.com/koala-sandbox/frontend-service/api"
)
...
func HelloKoala(w http.ResponseWriter, req *http.Request) {
	...
	if err != nil {
		fmt.Fprintln(w, "Error reading VERSION file (frontend-service): "+err.Error())
		return
	}
	fmt.Fprintln(w, "Hello world! service:frontend-service version: "+string(VERSION))
}
